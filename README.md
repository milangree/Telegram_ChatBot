...
- 🔐 **人机验证**：新用户首次发消息需完成数学题验证，防止机器人骚扰
- 🚫 **封禁管理**：支持封禁 / 解封 / 永久封禁 / 用户自助申诉
- 📊 **数据统计**：总用户数、今日消息量、封禁人数实时展示
- 🖥️ **Vue 3 管理后台**：对话记录、用户管理、系统设置、Bot 配置一站式管理
...
> 本项目**仅使用 KV**，无需创建 D1 数据库，也无需修改任何配置文件。
...
**Q：如何更新代码？**
A：在 Fork 的仓库中合并上游更新后，Cloudflare Pages 会自动触发重新部署。
